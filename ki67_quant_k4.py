...
seg_path = os.path.join(fdpath,'segmentation_k4')

os.mkdir(seg_path)
result_csv = os.path.join(seg_path,'Ki67_Results_k4.csv')
...
def ihc_quant(filename,fdpath):
      ...
      #__image_preprocessing-filtering-normalization__
        ...
        imgoutput_name = imginput_name + '_seg_k4.tif' 
        ...
        bk_index = np.delete(np.array([0,1,2,3]),[DAB_index,He_index])
...
np.savetxt(result_csv,results, delimiter=',', 
